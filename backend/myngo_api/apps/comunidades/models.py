...
class Comunidad(models.Model):
    ...
    url_avatar=models.ImageField(upload_to='comunidades/avatares/', blank=True, null=True)
    url_portada=models.ImageField(upload_to='portadas/', blank=True, null=True)
    url_fondo=models.ImageField(upload_to='comunidades/fondos/', blank=True, null=True)
