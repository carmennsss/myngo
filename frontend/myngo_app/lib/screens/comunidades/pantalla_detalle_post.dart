              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_estaCargandoPost) ...[
                    ...
                    const SizedBox(height: 16),
                    Text(tr('postNotFound'), style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 16),
                    ElevatedButton(onPressed: widget.onBack ?? () => context.pop(), child: Text(tr('commonBack')))
                  ]
                ],
              ),
            ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              _formatFecha(_post!.fechaCreacion, locale),
                              style: GoogleFonts.outfit(
                                color: colorSubtexto,
                                fontSize: 14,
                              ),
