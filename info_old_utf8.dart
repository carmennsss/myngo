...
/// Widget que muestra la informaci├│n textual y acciones de un perfil.
  ...
  Widget _buildBioSection(Color colorTextoP, Color colorTextoS) {
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Text(
            (biografiaLocal == null || biografiaLocal!.isEmpty) ? 'Sin biograf├¡a' : biografiaLocal!,
            style: GoogleFonts.inter(
              fontSize: 16,
              height: 1.5,
